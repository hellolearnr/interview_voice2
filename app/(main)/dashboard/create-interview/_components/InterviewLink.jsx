...
import { ArrowLeft, Calendar, Clock, Copy, Hash, List, Mail, Plus } from 'lucide-react';
  ...
  return (
    ...
    <div className='w-full p-7 mt-6 rounded-lg bg-white'>
      <div className='flex justify-between items-center'>
        <h2 className='bold'>Interview Link</h2>
      ...
      <div className='mt-3 flex gap-3'>
        ...
        <div className='flex gap-5'>
          <h2 className='text-sm text-gray-500 flex gap-2 items-center'><Clock />{formData?.duration}30mins </h2>
          <h2 className='text-sm text-gray-500 flex gap-2 items-center'><List />{formData?.duration}10 Ques </h2>
          {/* <h2 className='text-sm text-gray-500 flex gap-2 items-center'><Calendar />{formData?.duration}30mins </h2> */}
        </div>
        </div>
    <div className='mt-7 bg-white p-5 rounded-lg w-full'>
      ...
      <Button variant={'outline'} className=''><Hash />Slack </Button>
      <Button variant={'outline'} className=''><Mail />Whatsapp</Button>
      </div>

    </div>
      <div className='flex justify-between gap-5 w-full mt-6'>
        <Link href={'/dashboard'}>
